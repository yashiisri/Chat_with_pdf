...
# installed.
TCL_PREFIX='D:/Projects/Chat_with_pdf/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Projects/Chat_with_pdf/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Projects/Chat_with_pdf/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Projects/Chat_with_pdf/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Projects/Chat_with_pdf/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Projects/Chat_with_pdf/venv\Library\lib\tclstub86.lib'
